...
case 'a' : puts("select mobile:\n");
	...
	char a;
		...
		a=getchar();
		if(a=='a'||a=='A') printf("you have selected Nokia E7 of price Rs 34,0000");
									
		else if (a=='b' || a=='B') puts("you have selected Samsung google nexus s of price Rs 25,0000\n");
			
		else if(a=='c'||a=='C') puts("you have selected Dell venue of price Rs 40,0000\n");
